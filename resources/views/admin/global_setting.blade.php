        ...
        <div class="box box-info">
            ...
            <form action="{{route('update.global_setting')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="address_ne" name="address_ne" class="form-control" placeholder="Address Nepali"
                        value="{{$global_setting->address_ne}}">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="instagram" name="instagram" class="form-control" placeholder="Instagram Link"
                        value="{{$global_setting->instagram}}">
                </div>

                <div class="form-group col-md-6">
                    <label for="other">Youtube Link</label>
                    <input type="text" id="youtube" name="youtube" class="form-control" placeholder="youtube Link"
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="page_keyword" name="page_keyword" class="form-control" placeholder="Page Keyword"
                        value="{{$global_setting->page_keyword}}">
                </div>
